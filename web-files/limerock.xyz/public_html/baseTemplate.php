...
<p>
Target Email: <?php echo htmlspecialchars($target_email); ?>

Target First: <?php echo htmlspecialchars($target_first); ?>

Target Last: <?php echo htmlspecialchars($target_last); ?>
